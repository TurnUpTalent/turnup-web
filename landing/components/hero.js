...
import prototypeImageOne from "../public/img/prototype-one.png"

const Hero = () => {
    return (
        <>
            <Container className="flex flex-wrap ">
                <div className="flex items-center w-full lg:w-1/2 pr-5">
                    <div className="max-w-2xl mb-8">
                        <h1 className="text-4xl font-bold leading-snug tracking-tight text-gray-800 lg:text-4xl lg:leading-tight xl:text-6xl xl:leading-tight dark:text-white">
                            Save an average of <span className="font-extrabold">$2000</span> per employee by predicting turnover with our AI systems
                        </h1>
                ...
                <div className="flex items-center justify-center w-full lg:w-1/2 pl-5 pb-4">
                    <div className="">
                        <Image
                            src={prototypeImageOne}
                            width="616"
                            height="617"
